...
function CatchError(fnCatch) {
    return function (target, propertyKey) {
        decorators_1.checkMemberDecoratorsOnly(`CatchError`, target, propertyKey);
        reflect_metadata_util_1.setMemberMetadata(exports.SymCatchError, fnCatch, target, propertyKey);
    };
}
exports.CatchError = CatchError;
function getCatchError(target, propertyKey) {
    return reflect_metadata_util_1.getMetadataLazy(exports.SymCatchError, target, propertyKey);
}
