...
function setHookReturnValue(callback, target, propertyKey) {
    reflect_metadata_util_1.setMemberMetadata(exports.SymHookReturnValue, callback, target, propertyKey);
}
exports.setHookReturnValue = setHookReturnValue;
function getHookReturnValue(target, propertyKey) {
    return reflect_metadata_util_1.getMetadataLazy(exports.SymHookReturnValue, target, propertyKey);
}
